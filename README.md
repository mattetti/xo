...
This fork adds support for https://gopkg.in/guregu/null.v3 for mysql.
...
```sh
$ go get -u github.com/mattetti/xo

# install with oracle support (see notes below)
$ go get -tags oracle -u github.com/mattetti/xo
```
...
$ cp "$GOPATH/src/github.com/mattetti/xo/templates/*" templates/
...
$ sudo cp $GOPATH/src/github.com/mattetti/xo/contrib/oci8.pc /usr/lib/pkgconfig/
...
$ go install -tags oracle github.com/mattetti/xo
```
...
then you can define the key type as _INT_ instead of _INTEGER_, for example as in the following many-to-many
link table:
...
- [usql](https://github.com/mattetti/usql) - a universal command-line interface for SQL databases
